                            ...
                            <div class="col-sm-10" style="width: 300px;">
                                <select class="form-control" id="create-appellation">
                                    ...
                                    <c:forEach items="${applicationScope.appellationList}" var="a">
                                        <option vlaue="${a.value}">${a.text}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            ...
                            <div class="col-sm-10" style="width: 300px;">
                                <select class="form-control" id="create-state">
                                    ...
                                    <c:forEach items="${applicationScope.clueStateList}" var="c">
                                        <option vlaue="${c.value}">${c.text}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-10" style="width: 300px;">
                                <select class="form-control" id="create-source">
                                    ...
                                    <c:forEach items="${applicationScope.sourceList}" var="s">
                                        <option vlaue="${s.value}">${s.text}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td><a style="text-decoration: none; cursor: pointer;"
                               onclick="window.location.href='workbench/clue/detail.do?id=c453c84bc281409a91aaf822d617ab8f';">马云先生</a></td>
                        <td>动力节点</td>
                        <td>010-84846003</td>
                        <td>12345678901</td>
                        <td>广告</td>
