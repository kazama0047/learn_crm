    ...
    <script type="text/javascript">
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.success) {
                            ...
                            html += '<font color="gray"></font> <font color="gray">-</font> <b>${a.name}</b> <small style="color: gray;" id="s'+data.ar.id+'">';
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (i, n) {
                        ...
                        html += '<font color="gray"></font> <font color="gray">-</font> <b>${a.name}</b> <small style="color: gray;" id="s'+n.id+'">';
                    ...
                    // 在指定标签前追加元素(也可以找到上个兄弟元素,使用append追加)
                    $("#remarkDiv").before(html);
                }
            })
        }
        ...
        function deleteRemark(id) {
            $.ajax({
                ...
                success: function (data) {
                    if (data.success) {
                        // 如果直接调用showRemarkList(),会将修改后的数据追加进去
                        // 添加 id属性,直接删除元素
                        $("#" + id).remove();
                    } else {
                        alert("删除失败");
